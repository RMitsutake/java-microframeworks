...
public class PokemonMapperProvider implements DbMapperProvider {
    ...
    static class PokemonMapper implements DbMapper<Pokemon> {
        ...
        public Pokemon read(DbRow row) {
            ...
            DbColumn typeId = row.column("id_type");
            DbColumn weight = row.column("weight");
            return new Pokemon(id.as(Integer.class), name.as(String.class), typeId.as(Integer.class), weight.as(Double.class));
        }
